 ...
 */
package us.swcraft.springframework.store.serialiization;
...
import us.swcraft.springframework.store.serialization.KryoReflectionSupportSerializer;
import us.swcraft.springframework.store.serialization.KryoSerializer;

public class KryoReflectionSupportSerializerTest {
    ...
    public void serializeAndDeserializeCompressionSnappy_String() throws IOException {
        ...
        KryoSerializer<String> converter = new KryoReflectionSupportSerializer<>(StoreCompression.SNAPPY);
    ...
    public void serializeAndDeserializeCompressionSnappy_byteArray() throws IOException {
        ...
        KryoSerializer<byte[]> converter = new KryoReflectionSupportSerializer<>(StoreCompression.SNAPPY);
    ...
    public void serializeAndDeserializeCompressionSnappy_map() throws IOException {
        ...
        KryoSerializer<HashMap> converter = new KryoReflectionSupportSerializer<>(StoreCompression.SNAPPY);
        ...
        HashMap<String, Object> result = converter.deserialize(marshalled, HashMap.class);
    ...
    public void serializeAndDeserializeCompressionNone_String() throws IOException {
        String token = "Vestibulum ut consectetur orci. Nullam pulvinar dui quis scelerisque suscipit. Integer in nisl a orci imperdiet posuere.";
        KryoSerializer<String> converter = new KryoReflectionSupportSerializer<>(StoreCompression.NONE);
